...
# Get formatted prayer display string (internal implementation)
...
# Get compact prayer display (shows only next prayer) (internal implementation)
...
# Get prayer status summary (shows prayer completion status) (internal implementation)
