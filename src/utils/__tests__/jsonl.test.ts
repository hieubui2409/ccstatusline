...
function findBlockStartTime(
  ...
  if (!mostRecentTimestamp) return null;
...
describe("Block Detection Algorithm", () => {
  ...
  describe("Edge cases", () => {
    ...
    it("should return null when no messages within 5 hours", () => {
      const content = createMockTimestamps(["2025-09-23T08:00:00.000Z"]);
    ...
    it("should handle block boundary correctly", () => {
      const content = createMockTimestamps(["2025-09-23T10:30:00.000Z"]);
