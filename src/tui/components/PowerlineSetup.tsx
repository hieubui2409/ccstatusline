...
export const PowerlineSetup: React.FC<PowerlineSetupProps> = ({
    ...
    const getCapDisplay = (type: 'start' | 'end'): string => {
        const caps
      = type === 'start' ? powerlineConfig.startCaps : powerlineConfig.endCaps;
            ...
            {confirmingFontInstall ? (
                <Box flexDirection='column'>
                    ...
                    <Box marginBottom={1} flexDirection='column'>
                        ...
                        {os.platform() === 'darwin' && (
                            <>
                                ...
                                <Text dimColor>
                                    {' '}
                                    - Copy all .ttf/.otf files to ~/Library/Fonts
                                </Text>
                        ...
                        {os.platform() === 'linux' && (
                            <>
                                ...
                                <Text dimColor>
                                    {' '}
                                    - Copy all .ttf/.otf files to ~/.local/share/fonts
                                </Text>
                    ...
                    <Box marginBottom={1}>
                        ...
                        <Text dimColor>
                            Git installed, Internet connection, Write permissions
                        </Text>
                    </Box>
                ...
                <Box flexDirection='column' marginTop={1}>
                    {hasSeparatorItems && (
                        <>
                            <Box>
                                <Text color='yellow'>
                                    ⚠ Warning: Enabling Powerline mode will remove all existing
                                    separators and flex-separators from your status lines.
                                </Text>
                            </Box>
                            <Box marginBottom={1}>
                                <Text dimColor>
                                    Powerline mode uses its own separator system and is
                                    incompatible with manual separators.
                                </Text>
                            </Box>
                        </>
                    )}
                  ...
                  = !powerlineConfig.theme || powerlineConfig.theme === 'custom'
                      ...
                      powerlineConfig.separatorInvertBackground
                                    ...
                                    defaultPadding: ' ', // Set padding to space when enabling powerline
                                    lines: settings.lines.map(line => line.filter(
                ...
                <Box>
                    <Text color='yellow'>
                        Installing Powerline fonts... This may take a moment.
                    </Text>
                </Box>
            ) : fontInstallMessage ? (
                <Box flexDirection='column'>
                ...
                <>
                        ...
                        <Text>
                            ...
                            {powerlineFontStatus.installed ? (
                                <>
                                    ...
                                    <Text dimColor>
                                        {' '}
                                        - Ensure fonts are active in your terminal
                                    </Text>
                                </>
                            ) : (
                                <>
                    ...
                    {powerlineConfig.enabled && (
                        <>
                            ...
                            <Box flexDirection='column' marginTop={1}>
                                <Text dimColor>
                                    When enabled, global overrides are disabled and powerline
                                    separators are used
                                </Text>
                            </Box>
                        </>
